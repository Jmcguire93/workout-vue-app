      ...
      <div id="header-wrapper">
        <div class="container">
          ...
          <header id="header">
            <div class="inner">
              <!-- Logo -->
              <h1><a href="index.html" id="logo">WorkoutApp</a></h1>
              ...
              <div class="row">
                ...
                <div class="col-12">
                  <p>
                    ...
                    Etiam eu ante risus. Aliquam erat volutpat. Aliquam luctus mattis lectus sit amet pulvinar. Nam nec
                    turpis.
                  </p>
                </div>
              </div>
                    ...
                    <article class="box excerpt">
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          nisi consequat etiam lorem. Phasellus quam turpis, feugiat et sit amet ornare in, hendrerit in
                          lectus semper mod quis eget mi dolore.
                        </p>
                      </div>
                    </article>
